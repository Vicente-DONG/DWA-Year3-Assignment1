 ...
 * @author Vicen
 */
public class searchSwimmingEventsPanelSwimmer implements ActionListener {

    private JPanel searchSwimmingEventsPanelSwimmer;
    ...
    public searchSwimmingEventsPanelSwimmer() {
        searchSwimmingEventsPanelSwimmer = new JPanel(new BorderLayout());

        searchSwimmingEventsPanelSwimmer.add(navigationPanel(), BorderLayout.NORTH);
        searchSwimmingEventsPanelSwimmer.add(mainContentPanel(), BorderLayout.CENTER);
    }
    ...
    private JPanel filtersPanel() {
        ...
        filtersPanel.add(swimmerNameFilterPanel());
    ...
    public JPanel getSearchSwimmingEventsPanelSwimmer() {
        return searchSwimmingEventsPanelSwimmer;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == searchButton || e.getSource() == seeEventResultsButton) {
            ...
            if (e.getSource() == searchButton) {
                String outputString = "================================ YOUR EVENTS ===================================\n";
                ArrayList<eventModel> swimmerEvents = controller.getSwimmerEventsFromArray(events);

                for (int i = 0; i < swimmerEvents.size(); i++) {
                    outputString += swimmerEvents.get(i).toString() + "\n";
                }

                outputString += "\n================================ OTHER EVENTS ===================================\n";
                ArrayList<eventModel> otherEvents = controller.getNonSwimmerEventsFromArray(events);

                for (int i = 0; i < otherEvents.size(); i++) {
                    outputString += otherEvents.get(i).toString() + "\n";
                }
                
                displayTextArea.setText(outputString);
            } else if (e.getSource() == seeEventResultsButton)
            {
                String outputString = "================================ YOUR EVENT RESULTS ===================================\n";
                ArrayList<eventModel> swimmerEvents = controller.getSwimmerEventsFromArray(events);
                ArrayList<eventResultModel> swimmerResults = controller.getAllEventResults();
                
                for (int i = 0; i < swimmerEvents.size(); i++) {
                    for (int j = 0; j < swimmerResults.size(); j++) {
                        if(swimmerResults.get(j).getEventID() != swimmerEvents.get(i).getEventID())
                        {
                            swimmerResults.remove(j);
                        }
                    }
                }
                
                for (int i = 0; i < swimmerResults.size(); i++) {
                   if(!swimmerResults.get(i).getSwimmerName().equalsIgnoreCase(controller.getUsersName()))
                   {
                       swimmerResults.remove(i);
                   }
                }
                
                for (int i = 0; i < swimmerResults.size(); i++) {
                    outputString += swimmerResults.get(i).toString() + "\n\n";
                }
                ...
                for (int i = 0; i < otherEvents.size(); i++) {
                    for (int j = 0; j < otherResults.size(); j++) {
                        if(otherResults.get(j).getEventID() != otherEvents.get(i).getEventID())
                        {
                ...
                for (int i = 0; i < otherResults.size(); i++) {
                   if(otherResults.get(i).getSwimmerName().equalsIgnoreCase(controller.getUsersName()))
                   {
                       otherResults.remove(i);
                   }
                }
            ...
            ArrayList<eventResultModel> eventResults;
        } else if (e.getSource() == backButton) {
            searchSwimmingEventsPanelSwimmer.setVisible(false);
            searchSwimmingEventsPanelSwimmer.getParent().add(new swimmerMenuPanel().getswimmerMenuPanel());
            searchSwimmingEventsPanelSwimmer.getParent().remove(searchSwimmingEventsPanelSwimmer);
        } else if (e.getSource() == logOffButton) {
            logInFrame logInFrame = new logInFrame();
            SwingUtilities.getWindowAncestor(searchSwimmingEventsPanelSwimmer).dispose();
        }
    }
}
